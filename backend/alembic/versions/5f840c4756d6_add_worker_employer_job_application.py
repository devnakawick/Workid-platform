...
def upgrade() -> None:
    ...
    op.execute("DO $$ BEGIN CREATE TYPE user_type AS ENUM ('WORKER', 'EMPLOYER', 'ADMIN'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;")
    
    # Define enum without automatic creation
    user_type_enum = sa.Enum('WORKER', 'EMPLOYER', 'ADMIN', name='user_type', create_type=False)
