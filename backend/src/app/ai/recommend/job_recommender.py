...
class JobRecommender:
    """
    Hybrid job recommendation system combining:
    - Collaborative filtering (what similar workers applied to)
    - Content-based filtering (job-worker match scoring)
    """
    ...
    def collaborative_filtering(
        ...
        """
        Recommend jobs based on what similar workers applied to
    ...
    def hybrid_recommend(
        ...
        Args:
            ...
            available_jobs: List of available job dictionaries
