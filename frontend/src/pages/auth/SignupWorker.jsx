...
export default function SignupWorker() {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      navigate('/verify-otp', { state: { email: formData.phone, role: 'worker' } });
    } catch (error) {
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
          ...
          <div className="text-center space-y-4">
            ...
            <div className="pt-2 border-t border-gray-50">
              ...
              >
                {t('landing.signupAsDesc').split(' ')[0]} {t('auth.employer')}? <span className="underline decoration-gray-200">Click here</span>
              </button>
            </div>
          </div>
        </div>
