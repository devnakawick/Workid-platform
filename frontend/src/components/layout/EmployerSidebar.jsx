...
const employerMenuItems = [
    ...
    { path: '/employer/manage-jobs', icon: Briefcase, labelKey: 'nav.manageJobs', fallback: 'Manage Jobs' },
    { path: '/employer/applications', icon: FileText, labelKey: 'nav.applications', fallback: 'Applications' },
    { path: '/employer/payments', icon: DollarSign, labelKey: 'nav.payments', fallback: 'Payments' },
    { path: '/employer/support', icon: HelpCircle, labelKey: 'nav.support', fallback: 'Support' },
        ...
        <>
            ...
            <nav className="mobile-bottom-nav">
                <div className="mobile-nav-inner">
                    {employerMenuItems.slice(0, 5).map(({ path, icon: Icon, labelKey, fallback }) => {
                        const active = location.pathname === path;
